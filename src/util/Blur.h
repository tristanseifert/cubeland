...
class Blur {
    private:
        constexpr static unsigned short const stackblur_mul[255] = {
            ...
            324,320,316,312,309,305,301,298,294,29,287,284,281,278,274,271,
    ...
    constexpr static unsigned char const stackblur_shr[255] = {
    ...
    private:
        /**
         * Step of a stack blur.
         *
         * Radius must be 2..254.
         */
        static void stackblurJob(unsigned char* src, unsigned int w, unsigned int h,
                unsigned int radius, int cores, int core, int step, uint8_t *stack) {
    ...
    public:
        /**
         * Performs a stack blur over the given image buffer.
         *
         * See http://incubator.quasimondo.com/processing/fast_blur_deluxe.php for more information
         * on the blurring algorithm.
         *
         * @note This only works with 32bpp RGBA images. Radius must be [2, 254].
         */
        static void StackBlur(uint8_t *buf, const glm::ivec2 &size, const size_t radius) {
            ...
            stackblurJob(buf, size.x, size.y, radius, 1, 0, 1, stack);
            stackblurJob(buf, size.x, size.y, radius, 1, 0, 2, stack);
