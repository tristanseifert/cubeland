...
class PrefsManager final {
    ...
    public:
        ...
        static const std::optional<std::vector<unsigned char>> getBlob(const std::string &key);
        static void setBlob(const std::string &key, const std::vector<unsigned char> &value);
        static void deleteBlob(const std::string &key);
