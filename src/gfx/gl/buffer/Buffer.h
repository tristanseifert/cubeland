...
class Buffer {
    ...
    public:
        ...
        void bufferData(const std::size_t size, const void *data);
        void replaceData(const std::size_t offset, const std::size_t size, const void *data);
        void replaceData(const std::size_t size, const void *data);
